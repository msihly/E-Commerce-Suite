...
const FloatingMenu = ({ children, position = "bottom right", isHorizontal, hasPadding }) => (
    <div className={`floating-menu ${position} ${isHorizontal ? "horizontal" : ""} ${hasPadding ? "has-padding" : ""}`.trim()}>
        {children}
    </div>
);
