...
export const defaultReqs = {
    ...
    pricePaid: { name: "Price Paid", type: "decimal" },
    productDescription: { name: "Description", maxLen: 2083 },
    productId: { name: "Product", type: "integer" },
    productName: { name: "Name", maxLen: 2083 },
    productType: { name: "Type", maxLen: 255 },
    quantity: { name: "Quantity", type: "decimal" },
    state: { name: "State", maxLen: 255 },
    street: { name: "Street", maxLen: 255 },
    unitPrice: { name: "Unit Price", type: "decimal" },
